...
<head>
	...
	<script type="text/javascript" src="<%=rootPath%>/page/custmgnt/js/sloRuleMgnt.js"></script>
</head>
<body style="background:#fff;padding:20px">
<div class="prodDataTable mb10">
	<div>
		<div class="list-inline pull-left pl10 mb10"><i18n:message code="i18n.custmgnt.prodinfo.CustNameLabel"/>：[<%=custName%>]</div>
	</div>
