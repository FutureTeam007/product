		...
		<table class="easyui-datagrid" style="width:99%;height:390px" id="incidentDataTable"
			...
			<thead>
				<tr>
					...
					<th data-options="field:'status'" width="5%">当前状态</th>
					<th data-options="field:'ccUserName'" width="5%">提交人</th>
					<th data-options="field:'registTime',sortable:true" width="8%">提交时间</th>
					<th data-options="field:'scOpName'" width="5%">处理人</th>
					<th data-options="field:'lastUpdateTime',sortable:true" width="8%">最近更新时间</th>
