...
<div class="register-wrapper">
	...
	<form class="form-horizonta register-form" style="width:70%" role="form" action="<%=rootPath%>/op/changebaseinfo" method="post" onsubmit="return validateModifyFormVars()">
		<div class="form-group clearfix">
		    <label for="acountNo" class="col-sm-2 control-label"><i18n:message code="i18n.opcenter.profile.AccountNoLabel"/></label>
		    <div class="col-sm-10">
		      	<input type="text" class="form-control small-control" id="acountNo" disabled="disabled" name="acountNo"  maxlength="30"/>
		    </div>
  		</div>
  		<div class="form-group clearfix">
		    <label for="opCode" class="col-sm-2 control-label"><i18n:message code="i18n.opcenter.profile.OpCodeLabel"/></label>
		    <div class="col-sm-10">
		      	<input type="text" class="form-control small-control" id="opCode"  name="opCode"  maxlength="30"/>
		    </div>
  		</div>
  		<div class="form-group clearfix">
		    <label for="companySel" class="col-sm-2 control-label"><i18n:message code="i18n.opcenter.profile.RoleLabel"/></label>
		    <div class="col-sm-10">
  		...
  		<div class="form-group clearfix">
		    <label for="chineseName" class="col-sm-2 control-label"><i18n:message code="i18n.opcenter.profile.ChineseNameLabel"/></label>
		    <div class="col-sm-10">
		      	<input type="text" class="form-control small-control" id="chineseName"  name="chineseName" maxlength="40"/>
		    </div>
  		</div>
  		<div class="form-group clearfix">
		    <label for="givenName" class="col-sm-2 control-label"><i18n:message code="ii18n.opcenter.profile.EnginshFirstNameLabel"/></label>
		    <div class="col-sm-4">
  		...
  		<div class="form-group clearfix">
		    <label for="moduleSel" class="col-sm-2 control-label"><i18n:message code="i18n.opcenter.profile.GenderLabel"/></label>
		    <div class="col-sm-10">
		        <span class="radio-inline">
  		...
  		<div class="form-group clearfix">
		    <label for="mobileNo" class="col-sm-2 control-label"><i18n:message code="i18n.opcenter.profile.MobileLabel"/></label>
		    <div class="col-sm-10">
		      	<input type="text" class="form-control small-control" id="mobileNo"  name="mobileNo" maxlength="11"/>
		    </div>
  		</div>
  		<div class="form-group clearfix">
		    <label for="phoneNo" class="col-sm-2 control-label"><i18n:message code="i18n.opcenter.profile.PhoneLabel"/></label>
		    <div class="col-sm-2">
