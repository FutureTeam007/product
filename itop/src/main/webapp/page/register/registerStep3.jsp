...
<div class="register-nav">
	...
	<div class="register-step register-step-active"><i18n:message code="i18n.register.TitleStep3"/></div>
</div>
	...
	<div class="panel panel-warning">
      ...
      <div class="panel-body success-content middle-content" >
      		<% if("0".equals(request.getAttribute("success"))){%>
         		<a href="<%=rootPath%>/register" class="btn btn-link" ><i18n:message code="i18n.register.LinkBtnRegister"/></a>
         	<% }else{%>
         		<a href="<%=rootPath%>/login.jsp" class="btn btn-link" ><i18n:message code="i18n.register.LinkBtnLogin"/></a>
         	<% }%>
      </div>
    </div>
</div>
