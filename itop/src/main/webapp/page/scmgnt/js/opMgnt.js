...
function initOpDataGrid(){
	$('#opDataTable').datagrid({
	    ...
	    columns:[[
	        {field:'state',width:fixWidth(0.07),title:i18n.scmgnt.opinfo.TableTitleOpState,formatter:userStateFormatter},
          ...
          {field:'firstName',width:fixWidth(0.08),title:i18n.scmgnt.opinfo.TableTitleFirstName,editor:{type:'textbox'}},
	        ...
	        {field:'opKind',width:fixWidth(0.10),title:i18n.scmgnt.opinfo.TableTitleOpKind,formatter:userTypeFormatter,editor:typeEditor},
